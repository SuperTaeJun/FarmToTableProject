...
//    private async Task BuildChunkInScene(ChunkPosition pos, Chunk chunk)
//    {
//        // Chunk 데이터를 월드 데이터로 변환 (인접 청크 정보 고려)
//        string[,,] chunkWorldData = ConvertChunkToWorldData(chunk);
//        var tcs = new TaskCompletionSource<bool>();

//        // ChunkGenerator에 인접 블록 체크 함수 전달
//        StartCoroutine(dynamicGenerator.GenerateDynamicChunkCoroutine(
//            pos,
//            chunkWorldData,
//            this.transform,
//            chunkObject => { chunkObjects[pos] = chunkObject; tcs.SetResult(true); },
//            IsBlockVisible // 블록 가시성 체크 함수 전달
//        ));

//        await tcs.Task;
//    }

//    // ChunkGenerator에서 사용할 블록 가시성 체크 함수
//    public bool IsBlockVisible(ChunkPosition chunkPos, int x, int y, int z)
//    {
//        Vector3Int[] directions = {
//            Vector3Int.left,    // -X
//            Vector3Int.right,   // +X
...
//        // 새로 빌드 (인접 청크 정보 고려)
//        string[,,] chunkWorldData = ConvertChunkToWorldData(chunk);
//        GameObject chunkObject = dynamicGenerator.GenerateDynamicChunk(chunkPos, chunkWorldData, IsBlockVisible);
//        chunkObjects[chunkPos] = chunkObject;
//    }
